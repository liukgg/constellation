...
module Constellation
  ...
  #射手座 Sagittarius 11/23 - 12/21
  #摩羯座 Capricorn   12/22 - 01/19
  def date_by_constellation(cons)
    case cons
    when "水瓶座"    then "01/20 - 02/18"
    when "Aquarius"    then "01/20 - 02/18"

    when "双鱼座"      then "02/19 - 03/20"
    when "Pisces"      then "02/19 - 03/20"

    when "白羊座"      then "03/21 - 04/19"
    when "Aries"       then "03/21 - 04/19"

    when "金牛座"      then "04/20 - 05/20"
    when "Taurus"      then "04/20 - 05/20"

    when "双子座"      then "05/21 - 06/21"
    when "Gemini"      then "05/21 - 06/21"

    when "巨蟹座"      then "06/22 - 07/22"
    when "Cancer"      then "06/22 - 07/22"

    when "狮子座"      then "07/23 - 08/22"
    when "Leo"         then "07/23 - 08/22"

    when "处女座"       then "08/23 - 09/22"
    when "Virgo"       then "08/23 - 09/22"

    when "天秤座"       then "09/23 - 10/23"
    when "Libra"       then "09/23 - 10/23"

    when "天蝎座"     then "10/24 - 11/22"
    when "Scorpio"     then "10/24 - 11/22"

    when "射手座" then "11/23 - 12/21"
    when "Sagittarius" then "11/23 - 12/21"

    when "摩羯座"   then "12/22 - 01/19"
    when "Capricorn"   then "12/22 - 01/19"
    else
      raise "No this constellation!"
    end
  end
